...
namespace EventEase.Controllers
{
    public class VenuesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,Capacity,IsAvailable")] Venue venue, IFormFile imageFile)
        {
        ...
        {
            var containerClient = new BlobContainerClient(new Uri($"https://{_storageAccountName}.blob.core.windows.net/{_containerName}?sp=racwdli&st=2025-04-30T14:29:21Z&se=2025-09-29T22:29:21Z&spr=https&sv=2024-11-04&sr=c&sig=ql%2FOXoXX80tWZeMspRMq28vSS2UKkGPsORI3VDCaZ2Y%3D"));
